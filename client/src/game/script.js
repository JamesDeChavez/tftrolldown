...
const extractedData = require('./DataFiles/en_us3.json') // file comes from https://raw.communitydragon.org/ > 'latest/' folder > 'cdragon/' folder > 'tft/' folder
const { setData } = extractedData
const currentSet = 'TFTSet9' // 'mutator' field from file setData file above
const setNumber = "9" // choose the correct set Number to use as property name of sets Object
