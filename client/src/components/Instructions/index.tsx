    ...
    return (
        <div className={className}>
            ...
            <ul className={`${className}_list`}>
                ...
                <li className={`${className}_listitemIndented`}>1. Refresh Shop - shop button or Shop keybind press</li>
                <li className={`${className}_listitemIndented`}>2. Buy XP - shop button or XP keybind press</li>
                <li className={`${className}_listitemIndented`}>3. Buy Units - click shop champion portrait</li>
                <li className={`${className}_listitemIndented`}>4. Sell Units - drag and drop unit from bench to shop or Sell keybind press while hovering unit</li>
